...
const notifications = [
  {
    icon: Smartphone,
    channel: "Push",
    target: "All registered devices · 12,482",
    message: "Flash Flood Warning issued for Cedar Valley.",
    time: "2 min ago",
  ...
  },
  {
    icon: MessageSquare,
    channel: "SMS",
    target: "Riverside zone · 3,210",
    message: "Move to higher ground. Avoid bridges and underpasses.",
    time: "4 min ago",
    status: "delivered" as const,
  },
  {
  ...
  },
  {
    icon: Bell,
    channel: "Email",
    target: "Subscribers · 8,940",
    message: "Updated evacuation routes available.",
    time: "12 min ago",
    status: "delivered" as const,
  },
];
